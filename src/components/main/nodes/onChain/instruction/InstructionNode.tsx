              ...
              {isEditingPublicKey ? (
                ...
                <>
                  ...
                  <div className="absolute right-1 top-1/2 -translate-y-1/2 flex space-x-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button title="COpy" onClick={handleCopyPublicKey} className="p-0.5 rounded hover:bg-[#333]">
                      <Copy className="h-3 w-3 text-[#888] hover:text-white" />
                    </button>
                    <button title="Edit" onClick={() => setIsEditingPublicKey(true)} className="p-0.5 rounded hover:bg-[#333] edit-button">
              ...
              <div className="bg-[#1a1a24] p-1.5 rounded-sm text-xs font-mono border border-[#333] text-[#e1e2e6] relative overflow-hidden group editable-field">
                ...
                {isEditingOwner ? (
                  ...
                  <>
                    {owner}
                    <div className="absolute right-1 top-1/2 -translate-y-1/2 flex space-x-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button                     title="solana-cli"
 onClick={handleCopyOwner} className="p-0.5 rounded hover:bg-[#333]">
                        <Copy className="h-3 w-3 text-[#888] hover:text-white" />
                      </button>
                      <button                     title="solana-cli"
 onClick={() => setIsEditingOwner(true)} className="p-0.5 rounded hover:bg-[#333] edit-button">
                        <Edit2 className="h-3 w-3 text-[#888] hover:text-[#5d5dff]" />
                      </button>
                    </div>
                  </>
