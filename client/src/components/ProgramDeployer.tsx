  ...
  const handleDeploy = useCallback(
    async (event?: React.MouseEvent<HTMLButtonElement>) => {
      ...
      try {
        ...
        // 0. Retrieve deterministic program keypair generated by the build‑pipeline
        ...
        try {
          ...
          toast.error(
            'No deterministic Program ID found ‑ rebuild the project first.',
          );
          return;
        }

        // 1. Create ephemeral key for deployment (buffer authority)
