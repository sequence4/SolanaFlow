...
/** --- next.config.js — transpile problematic pkgs ------------------------- */
export const NEXT_CONFIG_JS = /* js */ `
/** Auto-generated by SolanaFlow */
module.exports = {
  /** Pre-transpile ESM-only deps so they don't break on first route-access */
  transpilePackages: [
    "@reown/appkit",
    "@walletconnect",
    "@msgpack",
