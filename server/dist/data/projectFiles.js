...
exports.createSampleFunctionTemplate = exports.apiHelperContent = exports.serverGitignoreContent = exports.serverEnvContent = exports.serverIndexContent = exports.tsConfig = exports.serverPackageJson = exports.rootPackageJson = exports.readMeMd = void 0;
exports.readMeMd = `
## Structure
- \`app/\`: Frontend application (React)
- \`server/\`: Backend server (Express)
`;
const rootPackageJson = (rootPath) => {
    return {
        "name": rootPath,
        "version": "0.1.0",
        "private": true,
...
const serverPackageJson = (rootPath) => {
    return {
...
exports.serverIndexContent = `import express from 'express';
    ...
    `;
exports.serverEnvContent = `PORT=3001
    SOLANA_NETWORK=devnet
    `;
exports.serverGitignoreContent = `# dependencies
    node_modules
    .pnp
    .pnp.js
...
export default api;
`;
const createSampleFunctionTemplate = (functionName) => `import * as fs from 'fs';
...
${functionName}();
`;
exports.createSampleFunctionTemplate = createSampleFunctionTemplate;
