  ...
  return (
    <footer className="bg-[#080912] border-t border-[#1e2033]">
      <div className="container mx-auto max-w-7xl px-4 py-10 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-1">
            ...
            <p className="text-gray-500 text-sm mb-4">
              Visual AI developer tool for Solana blockchain, making dApp development accessible to everyone.
            </p>
        ...
        <div className="mt-10 pt-6 border-t border-[#1e2033] flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-xs mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} SolanaFlow. All rights reserved.
          </p>
          <div className="flex items-center space-x-4">
            <img src="/assets/solana-logo.svg" alt="Solana Logo" className="h-5" />
            <span className="text-gray-500 text-xs">Built on Solana</span>
          </div>
        </div>
      </div>
    </footer>
